...
# Load model and cascade globally so it doesn't reload every frame
...
# WEBRTC CONFIGURATION (Ensures video works on mobile networks)
...
webrtc_streamer(
    ...
    media_stream_constraints={"video": True, "audio": False}, # We don't need audio!
